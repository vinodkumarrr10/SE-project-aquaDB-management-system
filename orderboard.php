    ...
    <div class="container">
        ...
        <div class="data">
            <div class="top">
                ...
                <p   style="font-size: 3em;color: lightslategrey;">Order Dashboard</p>
                <a href="inventoryhome.php"><button class="btnlogin-popup">Home</button></a>
            </div>
            <div class="popup-form" id="popup-form" >
                    <div class="form-container">
                        <h2>Enter Customer Details</h2><br>
                        <form id="customerForm" action="orderconnect.php" method="post">
                ...
                results.forEach(item => {
                    ...
                    resultElement.innerHTML = `
                        <div class='box'>
                            ...
                            <button class="add-to-cart" data-id="${item.id}" data-model="${item.model}" data-price="${item.price}">Order</button>
                        </div>
                    `;
