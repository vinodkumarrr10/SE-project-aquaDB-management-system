...
<head>
    <title> AquaDB rental- Registration  </title>
...
<body>
    ...
    <div class="container">
        <div class="#">
            <h1 class="text-center">AquaDB Rentals - Registration</h1><br>
            <br>
            <p class="text-center">Get started by creating customer account</p>
        </div><br>
    </div>

    <div class="container" style="margin-top: -1%; margin-bottom: 2%;  margin-left: 5%;">
        <div class="col-md-5 col-md-offset-4">
            <div class="panel panel-primary">
                <div class="panel-heading" style="background-color: steelblue;"> Create Account </div>
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-home" aria-hidden="true"></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-4">
                                <button class="btn btn-primary" type="submit" style="background-color: steelblue;">Submit</button>
                            </div>

                        </div>
                        <label style="margin-left: 5px;">or</label> <br>
                        <label style="margin-left: 5px;"><a href="customerlogin.php" style="color: steelblue;">Already Registered?</a></label>
